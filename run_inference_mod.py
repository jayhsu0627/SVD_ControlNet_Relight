...
if __name__ == "__main__":
    args = {
        ...
        # "validation_image_folder": "./video_2/img",
        # "validation_control_folder": "./video_2/depth",
        # "validation_image": "./video_2/output_0001.png",
        "validation_image_folder": "./validation_demo/img_relit",
        "validation_control_folder": "./validation_demo/shd_relit",
        "validation_image": "./validation_demo/img_relit/00976-tl-image_compo.png",
    ...
    controlnet = controlnet = ControlNetSDVModel.from_pretrained("/fs/nexus-scratch/sjxu/svd-temporal-controlnet/model_out",subfolder="controlnet")
    ...
    val_save_dir = os.path.join(args["output_dir"], "video_2")
